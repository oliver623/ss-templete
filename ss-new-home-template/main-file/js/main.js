			...
			document.getElementById('particles-js') &&
				particlesJS('particles-js', {
					particles: {
						...
						shape: { type: 'circle', stroke: { width: 0, color: '#fff' }, polygon: { nb_sides: 5 }, image: { src: 'img/github.svg', width: 50, height: 50 } },
						opacity: { value: 1, random: !0, anim: { enable: !0, speed: 0.2, opacity_min: 0, sync: !1 } },
